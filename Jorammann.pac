...
// إضافة نطاقات IP المحلية الخاصة بالأردن
const LOCAL_IP_RANGES = [
    { start: "192.168.0.0", end: "192.168.255.255" }, // نطاقات IP المحلية
    { start: "10.0.0.0", end: "10.255.255.255" },     // نطاقات IP المحلية
    { start: "172.16.0.0", end: "172.31.255.255" }    // نطاقات IP المحلية
];
