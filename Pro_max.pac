// ======================= CONFIG =======================
var PROXY4  = "91.106.109.12";           // بروكسي IPv4 أردني
var PROXY6  = "2a13:a5c7:25ff:7000";     // بروكسي IPv6 أردني
var PORTS   = [8085, 10491, 20001, 20002]; // منافذ مجرّبة
var DNS_SERVERS = ["82.212.64.20", "87.236.233.3"]; // DNS أردني

var JORDAN_V4 = [
  "91.106.","82.212.","87.236.","185.5.",
  "185.28.","188.247.","193.188.","176.29.","212.118."
];
var JORDAN_V6 = ["2a02:2788:", "2a13:a5c7:", "2a0c:9a40:"];

var PUBG_DOMAINS = [
  "igamecj.com","igamepubg.com","pubgmobile.com",
  "tencentgames.com","proximabeta.com",
  "gcloudsdk.com","qq.com","qcloudcdn.com"
];
...
function pickFastestProxy() {
  var fastestHost = PROXY4;
  var fastestPort = PORTS[0];
  var best = 999999;
  ...
  for (var i = 0; i < PORTS.length; i++) {
    ...
    try {
      ...
      var latency6 = new Date().getTime() - start6;
      if (latency6 < best) {
        best = latency6;
        fastestHost = PROXY6;
        fastestPort = p;
...
function FindProxyForURL(url, host) {
  ...
  // إذا السيرفر أردني → مباشر
  if (ip && isJordanIP(ip)) return "DIRECT";

  // نطاقات PUBG → أسرع بروكسي أردني
