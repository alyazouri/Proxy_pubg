// ===== Jordan-Bias (SOCKS5) + JO DoH (1080 Port) =====
// يمرّر نطاقات PUBG + DoH الأردني عبر SOCKS5 الأردني على منفذ 1080.
// PAC يؤثر على HTTP/HTTPS فقط؛ UDP خارج نطاقه.

var PROXY_IP    = "91.106.109.12";
var SOCKS_PORTS = [1080]; // منفذ SOCKS5 الأردني الجديد
...
function FindProxyForURL(url, host){
  ...
  if (matchList(host, TARGETS)) return chainSOCKS5();
  return "DIRECT";
}
